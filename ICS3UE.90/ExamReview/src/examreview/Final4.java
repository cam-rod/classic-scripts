...
public class Final4 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    double revenue;
    double profit;
    int totalSoldMonthly = 0;
    double revenueMonthly = 0;
    double profitMonthly = 0;
    ...
    displayResults(modelName, price, totalSoldMonthly, revenueMonthly, profitMonthly);
  }
  ...
  public static void displayResults (String modelName, double price, int totalSold,
    ...
    if (price == -1) {
      ...
      System.out.println("~~~~~\t\t~~~~~~~\t\t\t~~~~\t\t~~~~~~~\t\t\t~~~~~~~");
      System.out.println(modelName + "\t\tN/A\t\t\t"
